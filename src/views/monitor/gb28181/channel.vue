  ...
  <div class="app-container">
    ...
    <el-card shadow="hover">
        ...
        <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
                <el-button type="warning" plain icon="Close" @click="this.$router.back();">返回</el-button>
            </el-col>
        ...
        <el-table-column label="推流" align="center" prop="is_playing" />
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
            <template #default="scope">
              <el-button link="" type="primary" icon="View">播放</el-button>
            </template>
        </el-table-column>
        </el-table>
...
<script setup name="Device" lang="ts">
  import { listChannels } from "@/api/GB28181/Device";
  import { ChannelVO, ChannelQuery } from '@/api/Metro/Device/types';
...
const getList = async () => {
  ...
  const res = await listChannels(queryParams.value);
...
const deviceId = route.query.deviceId;
  if (deviceId != null) {
    queryParams.value.device_id=deviceId;
    getList();
  }
});
